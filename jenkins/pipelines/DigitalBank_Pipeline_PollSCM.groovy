...
node {
   ...
   stage('Run Tests') {
      ...
      {
        sh "'${mvnHome}/bin/mvn' -Dmaven.test.failure.ignore -DskipUnitTests clean verify -Dcucumber.options='--tags @positive' -Dserver.port=9092 -Dwebdriver.base.url='http://localhost:9092/bank' -Dwebdriver.driver=chrome -Dio.demo.bank.atm.host=atmlocationsearch1032-8080-default.mock.blazemeter.com"
      }
   }
